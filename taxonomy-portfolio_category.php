...
$nav_type = toffedassen_get_option( 'portfolio_type_nav' );
$css = 'list-portfolio';
...
<div id="primary" class="content-area <?php toffedassen_content_columns() ?>">
	<main id="main" class="site-main">
		...
		<?php
		/* toffedassen_portfolio_categories
		 *
		 */
		do_action( 'toffedassen_before_taxonomy_portfolio_list' );
		?>
		...
		<?php if ( have_posts() ) : ?>
			...
			<?php
			/* toffedassen_footer_portfolio_carousel
			 *
			 */
			do_action( 'toffedassen_after_portfolio_content' );
			?>
