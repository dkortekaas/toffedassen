...
if ( ! intval( toffedassen_get_option( 'related_posts' ) ) ) {
	return;
}
...
$numbers = intval( toffedassen_get_option( 'related_posts_numbers' ) );
...
?>
	<div class="toffedassen-related-posts blog-grid">
